...
<h1>A landing page conta com: </h1>

- Navbar fixa com efeito de vidro (glassmorphism) <br>
- Seção Hero com mockup de celular animado <br>
- Cards de funcionalidades em grid responsivo <br>
- Seção CTA com botões de download <br>
- Animações CSS suaves (fade-up e float) <br>
- Design 100% responsivo para mobile e desktop <br>
...
A página se adapta automaticamente para diferentes tamanhos de tela: <br>

✅ Desktop (1280px+) <br>
✅ Tablet (768px – 1279px) <br>
✅ Mobile (até 767px) <br>
